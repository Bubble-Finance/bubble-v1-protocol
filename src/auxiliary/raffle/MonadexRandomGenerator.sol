...
// import {ConfirmedOwner} from "../../../lib/chainlink-brownie-contracts/contracts/src/v0.8/";

contract MonadexRandomGenerator is VRFConsumerBaseV2 {
     ...
     */
    constructor(uint64 subscriptionId) VRFConsumerBaseV2(network_coordinator) {
        COORDINATOR = VRFCoordinatorV2Interface(network_coordinator);
    ...
    function requestRandomWords() external returns (uint256 requestId) {
        ...
        s_requests[requestId] =
            RequestStatus({ randomWords: new uint256[](0), exists: true, fulfilled: false });
